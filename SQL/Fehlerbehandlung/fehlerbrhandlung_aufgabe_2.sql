...
DROP PROCEDURE IF EXISTS farbVerbrauch;
...
BEGIN
    ...
    ## Checks 
    DECLARE own_error CONDITION FOR SQLSTATE '50000';
    ...
    IF NOT rot > innerRadius THEN
		SIGNAL own_error SET MESSAGE_TEXT = 'Fehler in den Parameterwerten';
    END IF;
